...
public class Weather implements Serializable{
	...
	private String date;//天气预报时间 "周二"
	
	private String dayPictureUrl;//白天的天气预报图片url ,图片url
	
	private String nightPictureUrl;//晚上的天气预报图片url ,图片url
	
	private String weather;//天气状况 ，"多云转阴"
	
	private String wind;//风力，"东北风微风"
	
	private String temperature;// 温度，"10 ~ 5℃"
