			...
			try {
				...
				if (value != null) {
					...
					if(value instanceof String){
						...
						s += DateUtil.dateToString((Date)value, DateUtil.YYYY_MM_DD_HH_MM_SS);
					} else {
						s += value;
					}
					sb.append(s);
...
//		String[] s = {"pageNo"};
//		System.out.println(pojoToUrlQueryStr(new qing.yunhui.common.bean.BaseQuery(), s));
//		s = new String[0];
//		System.out.println(pojoToUrlQueryStr(new qing.yun.hui.common.bean.BaseQuery(), s));
//		System.out.println(pojoToUrlQueryStr(new qing.yun.hui.common.bean.BaseQuery(), null));
//	}
}
